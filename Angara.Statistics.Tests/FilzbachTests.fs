...
let ParametersTests() =
    ...
    p1.GetDefinition "s" |> should equal {index=0; size=1; lower=0.; upper=1.; isFixed=false; isLog=false}
    ...
    p2.GetDefinition "v" |> should equal {index=0; size=2; lower=0.; upper=1.; isFixed=false; isLog=false}
    ...
    p3.GetDefinition "s" |> should equal {index=2; size=1; lower=0.; upper=1.; isFixed=false; isLog=false}
    p3.GetDefinition "v" |> should equal {index=0; size=2; lower=0.; upper=1.; isFixed=false; isLog=false}
    ...
    p4.GetDefinition "s" |> should equal {index=0; size=1; lower=0.; upper=1.; isFixed=false; isLog=false}
    p4.GetDefinition "v" |> should equal {index=1; size=2; lower=0.; upper=1.; isFixed=false; isLog=false}
